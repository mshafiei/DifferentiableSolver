...
parser.add_argument('--val_freq', default=101, help='Display frequency by iteration count')
...
parser.add_argument('--save_param_freq', default=1000, help='Maximum rotation')
