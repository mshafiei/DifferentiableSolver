...
elif(opts.model == 'fft' or opts.model == 'fft_image_grad' or opts.model == 'fft_helmholz' or opts.model == 'fft_highdim_filters' or 'fft_highdim' in opts.model or opts.model == 'fft_highdim_nohelmholz'):
