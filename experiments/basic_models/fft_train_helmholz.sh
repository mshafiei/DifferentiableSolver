...
name=msh-fft-solver-train-helmholze-phi1-psi1e2
helmholz='--delta_phi_init 1. --delta_psi_init 0.01 --expname fft_helmholze-phi1-psi1e2'
# name=msh-fft-solver-train-helmholze-phi1e2-psi1
# helmholz='--delta_phi_init 0.01 --delta_psi_init 1. --expname fft_helmholze-phi1e2-psi1'
# name=msh-fft-solver-train-helmholze-phi1-psi1
# helmholz='--delta_phi_init 1. --delta_psi_init 1. --expname fft_helmholze-phi1-psi1'
# name=msh-fft-solver-train-helmholze-phi1-psi1-fixed
# helmholz='--delta_phi_init 1. --delta_psi_init 1. --fixed_delta --expname fft_helmholze-phi1-psi1-fixed'
